##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.7.1] date: [Fri Aug 14 16:38:00 CST 2020]
##########################################################################################################################
...
-IHARDWARE/MPU6050 \
-IHARDWARE/EXTI \
-IMiniBalance/CONTROL \
-IMiniBalance/DataScope_DP \
-IHARDWARE/filter \
-IHARDWARE/ADC \
-IHARDWARE/CAN \
-IHARDWARE/ENCODER \
...
#######################################
flash:
	st-flash write build/meca_base.bin 0x08000000
